        ...
        matches.foldLeft(this) {
          case (
            ...
            matches
              ...
              .modify(
                _ -- matches.baseSpanningSectionsByPath.get(basePath).collect {
              ...
              .modify(
                _ -- matches.leftSpanningSectionsByPath.get(leftPath).collect {
              ...
              .modify(
                _ -- matches.rightSpanningSectionsByPath
                  .get(rightPath)
                  .collect {
